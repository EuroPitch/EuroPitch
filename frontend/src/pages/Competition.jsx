const Competition = () => (
    ...
    <h4>Evaluation</h4>
    <ul className="bullets">
    <li>Risk‑adjusted return (primary metric).</li>
    <li>Process quality & documentation.</li>
    <li>Communication & clarity in updates.</li>
    </ul>
    </div>
    </div>
    ...
    <div>
    <h4>Location</h4>
    <p>London (this year). Future host = country of the winning team.</p>
    </div>
    </div>
    </section>
